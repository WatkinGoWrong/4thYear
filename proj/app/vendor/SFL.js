function tree (){
    ...
    var comp = ['text','depth','parent','kids'];
...
//                redraw();
  ...
  tree.addFromJSON = function (parent,child,pos,depth) {
    ...
    getJSON = function(json_tree){//testing how to return json value and parameter names
      if(document.getElementById('tree-one').style.display == "none"){
        document.getElementById('tree-one').style.display = 'block';
        initialise();
      }
      resetTree();
      var myObj = json_tree;
    ...
    function getStruc(teacher,student){//testing how to return json value and parameter names
    ...
    function scan(obj,obj2){
        ...
        if(obj instanceof Object & obj2 instanceof Object){
          ...
          if(obj!=obj2){
            console.log('Difference found in values')
